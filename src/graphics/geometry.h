...
void graphics_geometry_drawRectangle(float x, float y, float w, float h, float rotation, float sx, float sy, float ox, float oy);
void graphics_geometry_fillRectangle(float x, float y, float w, float h, float rotation, float sx, float sy, float ox, float oy);
